...
class SVDmodel(object):
    ...
    def training(self,hp_dim,hp_reg,learning_rate,batch_size,num_steps):
        ...
        self.tf_model = tf_SVD(self.num_of_users,self.num_of_items,self.train_batches,self.test_batches,self.valid_batches)
    ...
    def prediction(self,list_of_users,list_of_items):
        return self.tf_model.prediction(list_of_users,list_of_items)
